...
// New based on brokers hosts, consumerGroup and topic. You need to close it after use. (Close())
...
func (wb *writeBroker) WriteMessages(ctx context.Context, msgs ...messaging.Message) error {
